        ...
        <div className="container">
          <div className="col-sm-12">
            <div className="mb-5 text-center">
              ...
              <p data-animate="fadeInUp" className="lead">I have worked on many projects so I have picked only the latest for you.</p>
            </div>
            <ul id="filter" data-animate="fadeInUp">
              ...
              <li><a href="#" data-filter="reactjs">React JS</a></li>
              <li><a href="#" data-filter="other">Other</a></li>
            </ul>
            <div id="detail">
              <div className="row">
                <div className="col-lg-10 mx-auto"><span className="close">×</span>
                  <div id="detail-slider" className="owl-carousel owl-theme" />
            ...
            <div id="references-masonry" data-animate="fadeInUp">
              <div className="row">
                <div data-category="webdesign" className="reference-item col-lg-3 col-md-6">
                  <div className="reference"><a href="#"><img src="img/portfolio-1.jpg" alt="" className="img-fluid" />
                    ...
                    <div data-images="img/main-slider1.jpg,img/main-slider2.jpg,img/main-slider3.jpg" className="sr-only reference-description">
                      ...
                      <p className="buttons text-center"><a href="javascript:void(0);" className="btn btn-outline-primary"><i className="fa fa-globe" /> Visit website</a><a href="javascript:void(0);" className="btn btn-outline-primary"><i className="fa fa-download" /> Download case study</a></p>
                    </div>
                  </div>
                </div>
                <div data-category="bootstrap" className="reference-item col-lg-3 col-md-6">
                  <div className="reference"><a href="#"><img src="img/portfolio-2.jpg" alt="" className="img-fluid" />
                      <div className="overlay">
                        <div className="inner">
                ...
                <div data-category="reactjs" className="reference-item col-lg-3 col-md-6">
                  <div className="reference"><a href="#"><img src="img/portfolio-3.jpg" alt="" className="img-fluid" />
                      <div className="overlay">
                        <div className="inner">
                ...
                <div data-category="reactjs" className="reference-item col-lg-3 col-md-6">
                  <div className="reference"><a href="#"><img src="img/portfolio-4.jpg" alt="" className="img-fluid" />
                      <div className="overlay">
                        <div className="inner">
                ...
                <div data-category="webdesign" className="reference-item col-lg-3 col-md-6">
                  <div className="reference"><a href="#"><img src="img/portfolio-5.jpg" alt="" className="img-fluid" />
                      <div className="overlay">
                        <div className="inner">
